...
repositoryRelativeGitHubAddress="Flexberry/flexberry-ember-demo"
...
do
  ...
  branchLink="<a href=\"${branch}\/index.html\">http:\/\/flexberry.github.io\/flexberry-ember-demo\/${branch}\/<\/a>"
