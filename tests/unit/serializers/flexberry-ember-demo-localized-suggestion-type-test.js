...
moduleForModel('flexberry-ember-demo-localized-suggestion-type', 'Unit | Serializer | flexberry-ember-demo-localized-suggestion-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:flexberry-ember-demo-localized-suggestion-type',
    'transform:file',
    'transform:decimal',
