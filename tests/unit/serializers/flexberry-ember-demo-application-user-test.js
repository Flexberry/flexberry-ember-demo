...
moduleForModel('flexberry-ember-demo-application-user', 'Unit | Serializer | flexberry-ember-demo-application-user', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:flexberry-ember-demo-application-user',
    'transform:file',
    'transform:decimal',
