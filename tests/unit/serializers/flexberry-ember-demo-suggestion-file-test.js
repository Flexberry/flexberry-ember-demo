...
moduleForModel('flexberry-ember-demo-suggestion-file', 'Unit | Serializer | flexberry-ember-demo-suggestion-file', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:flexberry-ember-demo-suggestion-file',
    'transform:file',
    'transform:decimal',
