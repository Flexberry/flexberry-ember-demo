...
moduleForModel('flexberry-ember-demo-suggestion-type', 'Unit | Serializer | flexberry-ember-demo-suggestion-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:flexberry-ember-demo-suggestion-type',
    'transform:file',
    'transform:decimal',
