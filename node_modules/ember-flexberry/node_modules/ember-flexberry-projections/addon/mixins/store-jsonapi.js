...
export default Ember.Mixin.create({
   ...
   */
    _normalizeQuery: function _normalizeQuery(modelName, query) {
      if (query && query.projection) {
        var projName = query.projection;
        var typeClass = this.modelFor(modelName);
        var proj = typeClass.projections.get(projName);
        var projQuery = getQuery(proj, this);

        delete query.projection;
	var jsonAPIFieilds={},listFields={};
	listFields[modelName]=projQuery.$select;
	jsonAPIFieilds['fields']=listFields;
	query = Ember.merge(query, jsonAPIFieilds);
