...
var Model = BaseModel.extend({
  ...
  userVotes: DS.hasMany('flexberry-ember-demo-vote', {inverse: null, async: false}),
  files: DS.hasMany('flexberry-ember-demo-suggestion-file', {inverse: null, async: false}),
  comments: DS.hasMany('flexberry-ember-demo-comment', {inverse: null, async: false}),
  validations: {}
});
