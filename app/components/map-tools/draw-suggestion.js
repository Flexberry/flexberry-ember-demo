...
import layout from '../../templates/components/map-tools/draw-suggestion';
...
*/
let DrawSuggestionMapToolComponent = Ember.Component.extend({
    /**
    ...
    */
    caption: t('components.map-tools.draw-suggestion.caption'),
...
export default DrawSuggestionMapToolComponent;
